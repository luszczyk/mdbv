package net.luszczyk.mdbv.common.beans;
...
public class BeanPostProcessorImpl implements BeanPostProcessor {
    ...
    public BeanPostProcessorImpl() {
        LOGGER.debug("BeanPostProcessorImpl construct " + this);
    }
    ...
    public Object postProcessAfterInitialization(Object arg0, String arg1)
        ...
        if (arg0 instanceof ViewerService) {
            ...
            for (String s : viewer.getTypeList()) {
                ...
                LOGGER.info("Actual list: " + registerService.getTypeList() +
                        "Add viewer for type: " + s);
            }
        }
        return arg0;
    }
